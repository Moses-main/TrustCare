...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // For demo: treat register as login
    login(role);
  ...
  return (
    <div style={{ display:'grid', placeItems:'center', minHeight:'calc(100vh - 160px)', padding:'40px 20px' }}>
      <div style={{ width:'100%', maxWidth:480, border:'1px solid #eee', borderRadius:16, padding:24, background:'#fff' }}>
        <div style={{ marginBottom:12 }}>
          <h2 style={{ margin:'0 0 6px 0' }}>Create your account</h2>
          <p style={{ margin:0, color:'#666' }}>Choose your role to get a tailored experience</p>
        </div>
